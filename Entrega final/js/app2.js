...
document.getElementById('filtrar').addEventListener('click', () => {
    const tituloFiltro = document.getElementById('titulo').value.toLowerCase();

    fetch('https://imdb-top-100-movies.p.rapidapi.com/', {
        method: "GET",
        headers: {
            'x-rapidapi-key': '4f72e14693msh7c8f2d6747b96f3p194224jsn32639b4813db',
...
function mostrarPeliculas(peliculas) {
    ...
    if (peliculas.length === 0) {
        ...
        peliculas.forEach(pelicula => {
            ...
            const calificacion = pelicula.rating;
            ...
            resultadosDi.innerHTML += `<p><strong>Título:</strong> ${titulo}<br>
                                        ...
                                        <strong>Director:</strong> ${director}</p><hr>`;
        });
    }
}